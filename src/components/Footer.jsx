const Footer = () => {
    ...
    <>
        ...
        <div>
            ...
            <a className="link link-hover">Tecnologia</a> 
            <a className="link link-hover">Aeroaplicaciones</a> 
            <a className="link link-hover">Siembra</a> 
            <a className="link link-hover">Relevamientos</a>
        </div> 
        <div>
            <span className="footer-title">La empresa</span> 
        ...
        <div>
            <span className="footer-title">El sitio</span> 
            <a className="link link-hover">Noticias</a> 
            <a className="link link-hover">Clientes</a> 
            <a className="link link-hover">Utilidades</a>
        </div>
        </footer> 
        ...
        <div className="items-center grid-flow-col">
            ...
            <p>AEROTECH Servicios Aereos - 2022</p>
        </div> 
